  ...
  <!-- <div class="gen" style="overflow-y: hidden">
    <div class="signUp">
      ...
      <div class="sylingForm" style="width:100%">
        <div class="SignInUp" style="flex-wrap: wrap;">
          <h2 class="CAccount">Create an Account</h2>
          <h5>
            <router-link to="SignIn" style="color: white">Sign In</router-link>
          </h5>
        </div>
...
<script>
import img2 from "../assets/Sasuke1.png";
export default {
  name: "SignUp",
  data() {
    return {
  ...
  methods: {
    async register() {
      await fetch("http://localhost/fr/RegisterC/insert", {
        method: "POST",
        headers: {
